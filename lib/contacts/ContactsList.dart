              ...
              return Scaffold(
                floatingActionButton: FloatingActionButton(
                  ...
                  onPressed: () async{
                    ...
                    contactsModel.setChosenDate(null.toString());
                        ...
                        Slidable(
                          ...
                          child: ListTile(
                            ...
                            onTap: () async {
                              ...
                              contactsModel.entityBeingEdited = await ContactsDBWorker.db.get(contact.id!.toInt());
        ...
        return AlertDialog(
            ...
            actions: [
              ...
              FlatButton(child: Text("Delete"),
                onPressed: () async {
                  await ContactsDBWorker.db.delete(inContact.id!.toInt());
                  Navigator.of(inAlertContext).pop();
