...
class AppointmentsList  extends StatelessWidget {
  Widget build(BuildContext inContext) {
    ...
    int i = 0; i < appointmentsModel.entityList.length; i++
      ...
      List dateParts = appointment.apptDate.toString().split(",");
              ...
              return Scaffold(
                  floatingActionButton: FloatingActionButton(
                    ...
                    onPressed: () async {
                      ...
                      appointmentsModel.setApptTime(null.toString());
                                              ...
                                              child: ListView.builder(
                                                  ...
                                                  itemBuilder: (
                                                    ...
                                                    if (appointment.apptTime != null) {
                                                      List timeParts = appointment.apptTime.toString().split(",");
  ...
  void _editAppointment(BuildContext inContext,
    ...
    if (appointmentsModel.entityBeingEdited.apptDate == null) {
      appointmentsModel.setChosenDate(null.toString());
    } else {
